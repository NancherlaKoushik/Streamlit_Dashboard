...
with cl1:
    with st.expander("Category ViewData"):
        ...
        st.download_button("Download Data", data = csv, file_name = "Category.csv", mime = "text/csv", help = 'Click here to download as CSV file')
...
with cl2:
    with st.expander("Region ViewData"):
        ...
        st.download_button("Download Data", data = csv, file_name = "Region.csv", mime = "text/csv", help = 'Click here to download as CSV file')
...
data1.update_layout(
    title={
        'text': "Relationship between Sales and Profits",
        'font': {'size': 20}
    },
    xaxis={
        'title': 'Sales',
